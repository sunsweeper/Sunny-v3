...
export async function POST(request: Request) {
  ...
  try {
    ...
    // ──────────────────────────────────────────────────────────────
    // STEP 2: Prioritize custom booking flow if in booking mode
    // ──────────────────────────────────────────────────────────────
...
Does everything look correct? Reply YES to confirm and book, or tell me what needs to change.
        ...
        // Extract values for TypeScript safety
        ...
        // Prompt again if user said something else during confirmation
    ...
    // ──────────────────────────────────────────────────────────────
    // STEP 3: Fall back to sunnyRuntime if not in booking mode
    // ──────────────────────────────────────────────────────────────
